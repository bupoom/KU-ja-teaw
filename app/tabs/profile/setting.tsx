...
const SettingsScreen: React.FC = () => {
    ...
    const [savedNotificationDays, setSavedNotificationDays] =
        useState<number>(1);
        ...
        <SafeAreaView className="flex-1 bg-white">
            ...
            <View className="flex-1 px-4 py-6">
                ...
                <View className="bg-white border border-gray-200 rounded-lg p-4 mb-4 shadow-sm">
                    ...
                    <View className="flex-row items-center justify-between mb-4">
                        ...
                        <Switch
                            ...
                            thumbColor={
                                notificationEnabled ? "#FFFFFF" : "#FFFFFF"
                            }
                        />
                    </View>
                    ...
                    <View className="flex-row items-center">
                        <View className="flex-row items-center mr-4">
                            <Feather
                                ...
                                size={16}
                                color={
                                    notificationEnabled ? "#374151" : "#9CA3AF"
                                }
                            />
                            <Text
                ...
                <TouchableOpacity
                    ...
                    className="mt-5 bg-white border border-gray-200 rounded-lg p-4 shadow-sm"
                >
                    <View className=" flex-row items-center justify-between">
                        <Text className="text-black font-medium text-xl">
                            test_refresh_token
