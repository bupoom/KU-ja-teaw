...
const SettingsScreen: React.FC = () => {
  ...
  const [savedNotificationEnabled, setSavedNotificationEnabled] = useState<boolean>(true);
  ...
  const validateAndSubmit = () => {
    const daysAsNumber = notificationDays === "" ? 0 : parseInt(notificationDays);
        ...
        <View className="bg-white border border-gray-200 rounded-lg p-4 mb-4 shadow-sm">
          ...
          {hasChanges && (
            <TouchableOpacity
              ...
              className="bg-green_2 py-3 px-4 rounded-lg"
            >
