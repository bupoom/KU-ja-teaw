...
export default function Plan() {
  ...
  const onPickEnd = () => {};
  const onPickPoster = () => {};
  const onNext = () => router.replace('/(tabs)/plan/setpassword');

  return (
    <SafeAreaView style={styles.safe}>
      {/* --- HEADER (kept in place) --- */}
      <TouchableOpacity
      ...
      <View style={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.dateRow}>
            <Pressable style={styles.dateInput} onPress={onPickStart}>
              <Feather name='calendar' size={16} />
              <Text style={styles.dateText}>Select Date</Text>
            </Pressable>
            <Pressable style={styles.dateInput} onPress={onPickEnd}>
              <Feather name='calendar' size={16} />
              <Text style={styles.dateText}>Select Date</Text>
            </Pressable>
          </View>
        ...
        <View style={styles.card}>
          ...
          <Pressable onPress={onPickPoster} style={styles.posterBox}>
...
const styles = StyleSheet.create({
  ...
  content: {
    marginTop: 130, // pushes below header/divider
