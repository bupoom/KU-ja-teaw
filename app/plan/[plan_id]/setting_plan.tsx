...
const PlanSetting = () => {
  ...
  const [newOwnerUsername, setnewOwnerUsername] = useState<string>("");
  ...
  const fetch_data = async () => {
    try {
      ...
      setPlanningStatus(
        TripsDetail.trip_status === true ? "complete" : "planning"
      );
      ...
      >
        ...
        <View className="bg-white rounded-lg p-4 mb-4 border border-gray_border flex-col">
          <View className="flex-row justify-between items-center mb-2">
            ...
            <TextInput
              value={tripBudget != null ? tripBudget.toString() : ""}
              onChangeText={(text) => {
                const numericText = text.replace(/[^0-9]/g, "");
                setTripBudget(numericText ? Number(numericText) : undefined);
              }}
      ...
      >
        ...
        <View className="flex-col bg-white p-4">
          <View className="flex-col items-start mb-2 mt-2">
            ...
            <Text className="text-gray-600">
              You&apos;re the trip Owner, Please assign your role before
              leaving.
            </Text>
          </View>
          ...
          {otherMembers.length >= 1 ? (
            ...
            <Text className="text-lg text-red-500 font-medium mb-3 ml-2">
              No one is managing this trip anymore. If you wish to remove it,
              please tap Delete Trip instead.
            </Text>
          )}
