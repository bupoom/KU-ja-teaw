...
const SearchOrBookmarkPlace: React.FC = () => {
    ...
    const fetchBookmarkPlaces = async () => {
        try {
            console.log("Starting fetch bookmark places...");
            setLoading(true);
            ...
            setLoading(false);
            console.log("Fetch bookmark completed");
        }
    };
    ...
    // const handlePlacePress = (place: string) => {
    //     router.push({
    ...
    const handleSearchPlacePress = (GOOGLEAPI: string) => {
        router.push({
            pathname:
                "/plan/[plan_id]/daily_trip/(modals)/add_place/[place_id]" as any,
            params: {
                id: GOOGLEAPI,
                type: "api",
                from_bookmark: 1,
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    handleSearchPlacePress(item.placeId)
                                }
                            >
