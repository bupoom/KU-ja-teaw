...
import { addPlaceToTrip } from "@/service/APIserver/activity";
import { truncateText } from "@/util/truncateText";

export default function PlaceDetail() {
    const { id, type, from_bookmark, plan_id, selectDate, start, end } =
        useLocalSearchParams();
    console.log(id, type, from_bookmark, plan_id, selectDate, start, end);
