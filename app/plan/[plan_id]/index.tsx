...
import {
  ...
  edit_flight,
  get_flight_detail,
} from "@/service/APIserver/Flight";
import {
  delete_file,
  get_all_file,
  get_download_link,
  upload_file,
} from "@/service/APIserver/File";
...
const PlanIndex = () => {
  ...
  const othersNotes = overviewNotes.filter(
    (note) => note.refer_user_id !== user_id
  );
  ...
  const handleSaveEdit = async (noteId: number, editText: string) => {
    try {
      const Edited = await edit_note(parseInt(plan_id), noteId, editText);
    ...
    <View className="flex-1 bg-white">
      ...
      >
        ...
        <View className="mx-4 mt-4 bg-white">
          ...
          >
            <Text className="text-xl font-bold text-black ml-4">Notes</Text>
            <Feather
          ...
          <ScrollView className="flex-1 p-4">
            ...
            <View className="mb-6">
              ...
              <View className="flex-row gap-4 mb-4">
                <View className="flex-1">
                  ...
                  >
                    <Text className="text-gray-700">
                      {flightForm.departure_date || "Select Date"}
                    </Text>
                  </TouchableOpacity>
                  {showDepartureDate && (
                    <DateTimePicker
                      value={
                        flightForm.departure_date
                          ? new Date(flightForm.departure_date)
                          : new Date()
                      }
                      mode="date"
                      display="default"
                      onChange={(e, date) => {
                        ...
                        onChangeDate(e, date, "departure_date");
                      }}
                    />
                  )}
                </View>
                ...
                <View className="flex-1">
                  <Text className="text-sm text-gray-700 mb-2">Time</Text>
                  <TouchableOpacity
                    onPress={() => setShowDepartureTime(true)}
                    className="bg-gray-100 rounded-lg p-3"
                  >
                    <Text className="text-gray-700">
                      {flightForm.departure_time || "Select Time"}
                    </Text>
                  </TouchableOpacity>
                  {showDepartureTime && (
                    <DateTimePicker
                      ...
                      onChange={(e, date) => {
                        ...
                        onChangeTime(e, date, "departure_time");
                      }}
                    />
                  )}
                </View>
            ...
            <View className="mb-6">
              ...
              <View className="flex-row gap-4 mb-4">
                <View className="flex-1">
                  ...
                  >
                    <Text className="text-gray-700">
                      {flightForm.arrival_date || "Select Date"}
                    </Text>
                  </TouchableOpacity>
                  {showArrivalDate && (
                    <DateTimePicker
                      value={
                        flightForm.arrival_date
                          ? new Date(flightForm.arrival_date)
                          : new Date()
                      }
                      mode="date"
                      display="default"
                      onChange={(e, date) => {
                        ...
                        onChangeDate(e, date, "arrival_date");
                      }}
                    />
                  )}
                </View>
                ...
                <View className="flex-1">
                  ...
                  >
                    <Text className="text-gray-700">
                      {flightForm.arrival_time || "Select Time"}
                    </Text>
                  </TouchableOpacity>
                  {showArrivalTime && (
                    <DateTimePicker
                      ...
                      onChange={(e, date) => {
                        ...
                        onChangeTime(e, date, "arrival_time");
                      }}
                    />
                  )}
                </View>
            ...
            {canEdit && editingFlightId && (
              <TouchableOpacity
                onPress={() => handleDeleteFlight(editingFlightId)}
