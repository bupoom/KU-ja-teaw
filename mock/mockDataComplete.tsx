...
export const mockTripMembers: TripMember[] = [
    {
        ...
        name: "John Smith",
        user_image:
            "https://imagesw.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
        email: "john.smith@email.com",
        phone: "+1-555-0123",
        role: "owner",
...
export const mockNotes: Note[] = [
    ...
    // ========== TRIP 2: European Backpacking Tour ==========
    {
        id: 3,
        note_text:
            "Remember to book train tickets in advance during peak season.",
        user_profile: mockUserDetails[2].profile_picture_link,
        user_name: mockUserDetails[2].name, // Michael Chen
        is_editable: true,
    ...
    },
    {
        id: 12,
        note_text:
            "Expenses lower than expected, mainly food and local transport.",
        user_profile: mockUserDetails[2].profile_picture_link,
...
export const mockActivityPlaceBoxes: ActivityPlaceBox[] = [
    // Trip 1: Summer Adventure in Japan
    {
        ...
        place_id: 1,
        title:
            mockPlaceBoxes.find(p => p.place_id === 1)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 2,
        title:
            mockPlaceBoxes.find(p => p.place_id === 2)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 16,
        title:
            mockPlaceBoxes.find(p => p.place_id === 16)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 18,
        title:
            mockPlaceBoxes.find(p => p.place_id === 18)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 17,
        title:
            mockPlaceBoxes.find(p => p.place_id === 17)?.title ??
            "Unknown Title",
        location:
    ...
    // Trip 2: European Backpacking Tour
    {
        ...
        place_id: 9,
        title:
            mockPlaceBoxes.find(p => p.place_id === 9)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 10,
        title:
            mockPlaceBoxes.find(p => p.place_id === 10)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 19,
        title:
            mockPlaceBoxes.find(p => p.place_id === 19)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 20,
        title:
            mockPlaceBoxes.find(p => p.place_id === 20)?.title ??
            "Unknown Title",
        location:
    ...
    // Trip 3: Thailand Beach Getaway
    {
        ...
        place_id: 13,
        title:
            mockPlaceBoxes.find(p => p.place_id === 13)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 14,
        title:
            mockPlaceBoxes.find(p => p.place_id === 14)?.title ??
            "Unknown Title",
        location:
    ...
    // Trip 4: Tokyo Winter Festival
    {
        ...
        place_id: 3,
        title:
            mockPlaceBoxes.find(p => p.place_id === 3)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 4,
        title:
            mockPlaceBoxes.find(p => p.place_id === 4)?.title ??
            "Unknown Title",
        location:
    ...
    // Trip 5: Bali Adventure
    {
        ...
        place_id: 5,
        title:
            mockPlaceBoxes.find(p => p.place_id === 5)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 6,
        title:
            mockPlaceBoxes.find(p => p.place_id === 6)?.title ??
            "Unknown Title",
        location:
    ...
    // Trip 6: Swiss Alps Hiking
    {
        ...
        place_id: 7,
        title:
            mockPlaceBoxes.find(p => p.place_id === 7)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 8,
        title:
            mockPlaceBoxes.find(p => p.place_id === 8)?.title ??
            "Unknown Title",
        location:
    ...
    // Trip 7: Trip to Thailand (Invitation)
    {
        ...
        place_id: 15,
        title:
            mockPlaceBoxes.find(p => p.place_id === 15)?.title ??
            "Unknown Title",
        location:
    ...
    // Trip 10: European Backpacker's Paradise
    {
        ...
        place_id: 11,
        title:
            mockPlaceBoxes.find(p => p.place_id === 11)?.title ??
            "Unknown Title",
        location:
    ...
    },
    {
        ...
        place_id: 12,
        title:
            mockPlaceBoxes.find(p => p.place_id === 12)?.title ??
            "Unknown Title",
        location:
...
export const mockTripInvitations: TripBox[] = [
    ...
    },
    {
        ...
        member_count: 6,
        status_planning: "planning",
        owner_name: mockTripMembers[9].name,
